...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Professional training in Tap, Jazz, and Ballet for all ages and skill levels." },
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        "description": "Professional training in Tap, Jazz, and Ballet for all ages and skill levels.",
        "url": "/",
      }),
    }],
  }),
