...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "WFVigVnT82Y8DwqrpXmRRLCFM4TFug8YMUUE1uRo5AQ" },
      { name: "google-site-verification", content: "GFtneT2yrOMdbkOmIejeB-JAf-Jc9_j8uNxxrS7wtFM" },
